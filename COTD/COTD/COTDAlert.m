...
{
    COTDAlert* alert = [[COTDAlert alloc] initWithFrame:frame textBlock:nil leftTitle:leftTitle leftBlock:leftBlock rightTitle:rightTitle rightBlock:rightBlock];
...
{
    COTDAlert* alert = [[COTDAlert alloc] initWithFrame:frame textBlock:textBlock leftTitle:leftTitle leftBlock:leftBlock rightTitle:rightTitle rightBlock:rightBlock];
